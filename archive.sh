...
help_info() {
    ...
    echo
    echo "Generally speaking, you should run this script via the terminal while in the autobass directory to ensure proper functionality."
    echo
    echo "Usage format:"
    ...
    echo " - Example: Adding the pattern '*.log' would exclude all log files."
    echo
}
